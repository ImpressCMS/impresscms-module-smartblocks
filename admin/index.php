...
?>
flexblokTree.icon = {
root            : flexblokTree_images + 'base.gif',
	folder          : flexblokTree_images + 'folder.gif',
	folderOpen      : flexblokTree_images + 'imgfolder.gif',
	node            : flexblokTree_images + 'imgfolder.gif',
	empty           : flexblokTree_images + 'empty.gif',
	line            : flexblokTree_images + 'line.gif',
	join            : flexblokTree_images + 'join.gif',
	joinBottom      : flexblokTree_images + 'joinbottom.gif',
	plus            : flexblokTree_images + 'plus.gif',
	plusBottom      : flexblokTree_images + 'plusbottom.gif',
	minus           : flexblokTree_images + 'minus.gif',
	minusBottom     : flexblokTree_images + 'minusbottom.gif',
	nlPlus          : flexblokTree_images + 'nolines_plus.gif',
	nlMinus         : flexblokTree_images + 'nolines_minus.gif'
};
flexblokTree.config.useLines = true;
flexblokTree.config.useIcons = false;
flexblokTree.config.useCookies = true;
flexblokTree.config.closeSameLevel = false;
flexblokTree.add(0, -1, '<?php echo _SMARTBLOCKS_SMARTBLOCKS; ?>', 'page.php?moduleid=0&location=0');
